...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_bannerSections,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<p class="sm_txt_nm">* Please upload jpg, png, jpeg files only, for best view please add above 1073px x 800px image.</p>
				<?php
				$image = '';
