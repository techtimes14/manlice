...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($new_testimonial,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
		 ...
		 <div class="form-group row">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('designation', ['required' => true, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Designation' ]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<p class="sm_txt_nm" style="margin-bottom:0;">* Please upload jpg, png, jpeg files only, for best view please add above 98px x 98px image.</p>
