							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_en', $productLocale['en']['product_name_en'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_en')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_zh', $productLocale['zh']['product_name_zh'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_zh')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_fr', $productLocale['fr']['product_name_fr'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_fr')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_de', $productLocale['de']['product_name_de'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_de')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_es', $productLocale['es']['product_name_es'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_es')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_ru', $productLocale['ru']['product_name_ru'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_ru')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_ja', $productLocale['ja']['product_name_ja'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_ja')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::text('product_name_ko', $productLocale['ko']['product_name_ko'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Title'), 'id' => 'product_name_ko')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_en', $productLocale['en']['description_en'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_en')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_zh', $productLocale['zh']['description_zh'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_zh')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_fr', $productLocale['fr']['description_fr'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_fr')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_de', $productLocale['de']['description_de'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_de')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_es', $productLocale['es']['description_es'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_es')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_ru', $productLocale['ru']['description_ru'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_ru')) !!}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_ja', $productLocale['ja']['description_ja'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_ja')) !!}
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										{!! Form::textarea('description_ko', $productLocale['ko']['description_ko'], array('required', 'class'=>'form-control', 'placeholder' => __('Enter Product Description'), 'id' => 'description_ko')) !!}
