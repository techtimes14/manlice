...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_service,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
		 ...
		 <div class="form-group row">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('sub_heading', ['required' => false, 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Sub Heading' ]); ?>
            </div>
         </div>
		 <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<p class="sm_txt_nm">* Please upload jpg, png, jpeg files only, for best view please add above 360px x 300px image.</p>
				<?php
				$image = '';
				if($existing_service->image !=''){
					if (file_exists(WWW_ROOT.'uploads/service/'.$existing_service->image)){
						$image = Router::url('/uploads/service/thumb/', true).$existing_service->image;
					}else{
				...
				?>
				<span id="pro_pic">
					<img src="<?php echo $image; ?>" width='150' height='100' style="border:1px solid #000; padding:5px;" />
				</span>
