...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($new_features, ['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<p class="sm_txt_nm" style="margin-bottom:0;">* Please upload jpg, png, jpeg files only, for best view please add above 59px x 64px image.</p>
		 ...
		 <div class="form-group row">
            ...
            <div class="col-sm-10">
				<?php echo $this->Form->input('image1', ['type'=>'file', 'required' => true, 'label' => false, 'class' => 'form-control boxed', 'accept'=>"image/*", 'onchange' => 'image_preview1(event)', 'autocomplete' => 'off']); ?>
         ...
         <div class="form-group row">
            <div class="col-sm-10 col-sm-offset-2">
               <?php echo $this->Form->button('Add',['type' => 'submit','class' => 'btn btn-primary']); ?>&nbsp;
				<a href="<?php echo Router::url('/admin/features/list-data',true); ?>" class="btn btn-primary">Cancel</a>
            </div>
         </div>
      </div>
