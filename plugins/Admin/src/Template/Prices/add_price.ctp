...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($new_price, ['id' => 'price-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
		 ...
		 <div class="form-group row" id="price_1_div">
            <label class="col-sm-2 form-control-label text-xs-right">
               Price 1:
            </label>
            <div class="col-sm-10">
		 ...
		 <div class="form-group row" id="price_2_div">
            <label class="col-sm-2 form-control-label text-xs-right">
               Price 2:
            </label>
            <div class="col-sm-10">
