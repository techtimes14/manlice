...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_feature,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<?php
				$image = '';
				if($existing_feature->image !=''){
					$image = Router::url('/uploads/features/thumb/', true).$existing_feature->image;
				}else{
		 ...
		 <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<?php
				$image = '';
				if($existing_feature->image1 !=''){
					$image1 = Router::url('/uploads/features/thumb1/', true).$existing_feature->image1;					
				}else{
