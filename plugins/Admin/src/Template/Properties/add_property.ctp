...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($new_property, ['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
		 ...
		 <div class="form-group row">
            ...
            <div class="col-sm-10">
				...
				<p class="sm_txt_nm" style="margin-bottom:0;">* Please upload jpg, png, jpeg files only, for best view please add above 60px x 60px image.</p>
