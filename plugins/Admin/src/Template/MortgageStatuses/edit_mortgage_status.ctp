...
<article class="content item-editor-page">
   ...
   <?php echo $this->Form->create($existing_mortgagestatus,['id' => 'login-form', 'novalidate' => 'novalidate', 'enctype'=>'multipart/form-data']); ?>
      <div class="card card-block">
         <div class="form-group row">
            ...
            <div class="col-sm-10">
               <?php echo $this->Form->input('title', ['required' => false, 'id' =>'banner_title', 'label' => false, 'class' => 'form-control boxed', 'placeholder' => 'Title' ]); ?>
            </div>
         </div>         
		<?php
